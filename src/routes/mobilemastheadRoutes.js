// src/routes/mobilemastheadRoutes.js
...
const tableName = TABLE.MOBILE_MASTHEAD;
const ine_mobile_masthead_ModuleID = TABLE.MOBILE_MASTHEAD_MODULE_ID;
...
router.delete('/', async (req, res) => {
    try {
        ...
        await Promise.all(deletedIds.map(async (deletedId) => {
            ...
            activityLog(ine_mobile_masthead_ModuleID, currentRecord, null, 3, 0);
        }));
