// src/routes/flower_rawmasterRoutes.js
...
const tableName = TABLE.FLOWER;
const ine_flower_ModuleID = TABLE.FLOWER_MODULE_ID;
...
router.post('/', async (req, res) => {
    try {
        ...
        await activityLog(ine_flower_ModuleID, null, insertedRecord, 1, 0); // Maintain Activity Log
...
router.put('/', async (req, res) => {
    try {
        ...
        const { name, description, apihitid } = await req.body;
        ...
        await activityLog(ine_flower_ModuleID, existingRecord, updatedRecord, 2, 0); // Maintain Activity Log
...
router.delete('/', async (req, res) => {
    try {
        ...
        await Promise.all(deletedIds.map(async (deletedId) => {
            ...
            activityLog(ine_flower_ModuleID, currentRecord, null, 3, 0);
        }));
