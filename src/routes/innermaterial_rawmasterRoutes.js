// src/routes/innermaterial_rawmasterRoutes.js
...
const tableName = TABLE.INNERMATERIAL;
const ine_inner_material_ModuleID = TABLE.INNERMATERIAL_MODULE_ID;
...
router.delete('/', async (req, res) => {
    try {
        ...
        await Promise.all(deletedIds.map(async (deletedId) => {
            ...
            activityLog(ine_inner_material_ModuleID, currentRecord, null, 3, 0);
        }));
