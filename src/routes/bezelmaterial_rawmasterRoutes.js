// src/routes/bezelmaterial_rawmasterRoutes.js
...
const tableName = TABLE.BEZELMATERIAL;
const ine_bezel_material_ModuleID = TABLE.BEZELMATERIAL_MODULE_ID;
...
router.post('/', async (req, res) => {
    try {
        ...
        await activityLog(ine_bezel_material_ModuleID, null, insertedRecord, 1, 0); // Maintain Activity Log
...
router.put('/', async (req, res) => {
    try {
        ...
        await activityLog(ine_bezel_material_ModuleID, existingRecord, updatedRecord, 2, 0); // Maintain Activity Log
...
router.delete('/', async (req, res) => {
    try {
        ...
        await Promise.all(deletedIds.map(async (deletedId) => {
            ...
            activityLog(ine_bezel_material_ModuleID, currentRecord, null, 3, 0);
        }));
